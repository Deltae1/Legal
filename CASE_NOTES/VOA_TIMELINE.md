# VOA_TIMELINE.md
# VOA / USAGM — Detailed Timeline & Evidence
# Updated: 2026-04-16

---

## Employment Overview
- **Employer:** Voice of America (VOA) / U.S. Agency for Global Media (USAGM)
- **Role:** Lead Technical Director
- **Period:** ~2020 – June 2024
- **Combined salary (WETA + VOA):** $200,000/year
...
- USAGM Director Amanda Bennett sent a staff-wide email encouraging employees to come forward with information to help save money and support the agency's mission
- This email is recoverable via USAGM email servers (FOIA + discovery)
...
## May–June 2024 — Contract Pressure Campaign

### USAGM Contract Postings
- USAGM Office of Contracts issued major postings for new headquarters operations
- Timing followed CI designation
- Social engineering tactics used: references to contracts made within Elvin's earshot
- Conference room "white paper" incident — contracts staff convened near Elvin's break spot, referenced opportunity within earshot (appeared deliberate)

### Elvin's Response
- Investigated the contracts
- Determined they were beyond his individual capacity
- Submitted ONLY what was within his legitimate qualifications
- Did not falsify anything, did not inflate credentials

---

## June 2024 — Resignation & Hospitalization

- Resigned from both WETA and VOA under extreme duress
- No formal written job offer or alternative opportunity at time of resignation
- Out of character, inconsistent with professional conduct
- Hospitalized at **George Washington University Hospital** same week
- Medical records in Elvin's possession

---

## July 2024 — Return to VOA

### Benjamin Johnas Contact
- **Benjamin Johnas** (VOA Director of Operations, now retired) personally contacted Elvin
- Sympathetic communication — asked Elvin to return to work
- Elvin returned but experienced elevated anxiety, difficulty concentrating, persistent sense of being targeted

### Reasonable Accommodation
- With therapist support, Elvin requested accommodation
- **Granted:** Work from home 4 days/week, on-site 1 day/week
...
| Witness | Role | Knowledge | Priority |
|---|---|---|---|
...
| Amanda Bennett | USAGM Director | Sent broadcast email; organizational context | 🟡 Medium |
...
- Medical records (GWH hospitalization)
- Reasonable accommodation approval
- Text messages with L'Enfant Plaza attorney
- Therapist records (authorization needed)
- VOA Exceptional Award documentation (if retained)

### Obtain via FOIA
- USAGM Security Office records referencing Elvin
- USAGM contract postings May–June 2024
- Amanda Bennett broadcast email
- All USAGM records referencing Elvin Sangano

### Obtain via Discovery
- VOA project logs (ROTV disruptions)
- Equipment/incident reports (studio blackouts)
- John Lipman emails re: Elvin's ROTV contributions
- USAGM internal communications re: Elvin
- CI designation records (if any exist internally)
- Benjamin Johnas communications re: Elvin's return

---

## The Award → Targeting Contrast (Core Narrative)

> "Elvin Sangano received VOA's highest performance award for three consecutive years — 2020, 2021, 2022, and 2023. He was the lead on a major automation upgrade project, recognized by VOA leadership for his contributions. In early 2024, a coordinated campaign of workplace sabotage, pressure, and harassment began. By June 2024, he had been forced to resign and was hospitalized. The only thing that changed between 2023 and 2024 was not his performance — it was the targeting."

This contrast is the spine of the VOA constructive discharge and retaliation claims.

---
*Updated 2026-04-16 by Mamba 🐍 — Not legal advice*
