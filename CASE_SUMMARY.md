# CASE SUMMARY — ELVIN SANGANO v. USAGM / WETA
# Attorney Intake Document
# Prepared: 2026-04-17
# ⚠️ PRIVILEGED AND CONFIDENTIAL — Attorney Use Only

---

## The Client

**Elvin Sangano** — Washington DC
- Former Lead Technical Director, VOA/USAGM (2020–2024)
- Former Technical Director, WETA Greater Washington
- Combined salary: ~$200,000/year
- PSC contractor, W-2 issued directly by USAGM (2020–2022 confirmed in possession)
- Operator of ONIV INC — registered broadcast technology consulting firm since 2017
...
## The Evidence — What Exists Right Now

### In Client's Possession
- W-2s from USAGM directly (2020–2022) — proves direct federal employment
- Termination letter — "termination for convenience" — zero performance basis
- FMLA approval — qualifying medical condition acknowledged by USAGM
- Reasonable accommodation approval — disability acknowledged by USAGM
- VOA Exceptional Performance Rating 4 (2021, 2022) — highest available
- WETA scheduling text messages (Nikki) — 2 years of discriminatory assignments
- WETA scheduling group thread — week-by-week assignment pattern
- Letter of recommendation from Jeff Reber (former VOA supervisor)
- GWH medical records (June 2024 hospitalization)
- Therapist records (work-related trauma — authorization needed)
- ONIV INC SAM submission (RFP 951700-24-R-0014) — truthful, no false statements
- ONIV INC Lead Designer Profile — complete capability statement
- Text messages with attorney (L'Enfant Plaza, mid-2024)

### Obtainable via FOIA
- USAGM security office records referencing Elvin Sangano
- USAGM contract postings May–June 2024
- Microsoft Teams meeting records May 17–28, 2024
- Any USAGM communications referencing Elvin Sangano

### Obtainable via Discovery
- Jim Schnider email (WETA) — Heather promotion trigger
- John Hawk communications (Jenkins Row) — contract pressure
- USAGM recall decision-maker communications
- Full RIF and recall list — who was cut, who was returned
- WETA scheduling records 2022–2024
- Badge/CCTV records — VOA conference room incident

---

## The Timeline — Condensed

- **2017** — ONIV INC registered, begins federal past performance
- **Nov 2020** — Hired as PSC Lead Technical Director at VOA to launch ROTV
- **2021–2022** — Performance Rating 4 (exceptional) both years
- **Early 2024** — Hostile work environment begins at WETA (Heather promotion/Schnider email); VOA sabotage of automation project begins
- **May 17–28, 2024** — USAGM Security CI pressure campaign; fraudulent contract scheme (RFP 951700-24-R-0014); Jenkins Row social engineering operation
- **May 31, 2024** — Termination for convenience citing DOGE cuts
- **Post-termination** — Benjamin Johnas (VOA Director Ops) requests Elvin return
- **Post-return** — Ongoing pressure, trauma, hospitalization (GWH June 2024)
- **Post-return** — FMLA approved; reasonable accommodation approved (WFH 4 days)
- **Final termination** — After both approvals — ADA + FMLA retaliation
- **2025** — Federal court rules DOGE cuts to USAGM illegal
- **2025–present** — Programming resumes, colleagues recalled — Elvin excluded
...
- Filing deadlines: Confirm EEOC/EEO counseling status immediately — federal employees have 45-day window from discriminatory act
- Two attorney types may be needed: federal employment/civil rights + federal contracts (FAR T4C settlement)
- FAR settlement proposal under FAR 49.1 may still be available — check contract limitations period
- Court ruling on DOGE cuts: obtain full citation — use as foundation for T4C void argument
- Bivens claims require separate analysis — federal officials acting under color of law
- Source protection: Elvin has sources regarding the CI operation and Jenkins Row sting — identities protected until attorney-client privilege established

---

## Full Case Files

All documentation, evidence analysis, timelines, and case notes are maintained at:
`/legal-case/` — organized by CASE_NOTES/, EVIDENCE/, STRATEGY/, FILINGS/, ATTORNEYS/

Key files:
- `CASE_NOTES/EMPLOYMENT_TIMELINE.md` — full chronological timeline
- `CASE_NOTES/CONTRACT_SCHEME.md` — CI pressure and contract scheme
- `CASE_NOTES/TERMINATION_FOR_CONVENIENCE_ANALYSIS.md` — T4C legal analysis
- `EVIDENCE/SAM_SUBMISSION_ANALYSIS.md` — SAM submission analysis
- `EVIDENCE/ONIV_LEAD_DESIGNER_PROFILE.md` — capability statement
- `EVIDENCE/EVIDENCE_CHECKLIST.md` — full evidence inventory

---
*Prepared by Mamba 🐍 — Not legal advice. For attorney review only.*
